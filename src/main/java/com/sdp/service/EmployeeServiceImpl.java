...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public AddEmployeeDto addEmployee(Integer departmentId,Employee employee) throws DepartmentException {
		...
		empObj.setPhoneNo(empObj.getPhoneNo());	
	...
	@Override
	public GetEmployeeDto changeEmployeeSalary(Integer employeeId,Double salary, Double bonusThatYear, Double benefitPoints) throws EmployeeException {
        ...
        salaryRecord.setYear(LocalDate.now().getYear());
        salaryRecord.setSalary(salary);
        salaryRecord.setBonusThatYear(bonusThatYear); // Default bonus // need to add
        salaryRecord.setBenefitPoints(benefitPoints); // Default benefit points // need to add
